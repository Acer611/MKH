...
public class ChannelController {
     ...
     * @return
     */
    @ApiOperation(value = "生成渠道号")
    @ResponseBody
    @GetMapping(value = "/batchGenerateChannel"/*,produces = {"application/json","application/xml"}*/)
    public List<ChannelResponse> batchGenerateChannel(@ApiParam(value = "开始渠道号", required = true)
                                                      ...
                                                      @ApiParam(value = "外链要跳转页面的ID,目前大多使用的为：5a3a0ff275657100436719b8 ", required = true)
        ...
        System.out.println("........."+channelResponseList.size());
